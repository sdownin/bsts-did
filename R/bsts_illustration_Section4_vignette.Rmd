...
Additionally, the last three sections present simulation results for examining 
(3) the effect of better vs. worse quality covirate series in BSTS models with 
regression, (4) BSTS causal inference on different causal cycle curve shapes,
and (5) sensitivity to Bayesian priors, such as regression spike-and-slab priors
(parameters for expected model size and expected R^2^). 
...
# 3. Covariate Quality and Regression Performance
