---
title: "Bayesian Structural Time Series (BSTS) for Dynamic Causal Inference"
output: pdf_document
---
...
and (5) sensitivity to Bayesian priors and regression spike-and-slab priors
(model size, expected R^2^). 
...
```{r, out.width="95%", fig.align="center", fig.dim=c(12, 8)}  
###
...
```{r mcmc_diag_fit,  out.width="95%", fig.align="center", fig.dim=c(12, 8)}
getBstsSummaryPlots(bsts.fit)
