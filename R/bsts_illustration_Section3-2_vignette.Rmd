...
y.pre.treat.NAs.post <- c( df1$y_treatment[pre.idx], rep(NA,length(post.idx)) )
## Then use the post-treatment response for causal impact estimation
post.period.response <- df1$y_treatment[post.idx]
...
st.sp <- AddSeasonal(st.sp, y.pre.treat.NAs.post, 
