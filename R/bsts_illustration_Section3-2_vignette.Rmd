...
CompareBstsModels(reslist.sdlow)
```
...
res.sdhigh <- runSimulationScenarioBstsModelComparison(df2)
...
## CALL THE FUNCTION TO RUN ON THE DF WITH CONTROL GROUP SERIES
res.ctrl.sdlow <- runSimulationScenarioBstsModelComparison(df12)
```
...
## CALL THE FUNCTION TO RUN ON THE DF WITH CONTROL GROUP SERIES
res.ctrl.sdhigh <- runSimulationScenarioBstsModelComparison(df22)
```
