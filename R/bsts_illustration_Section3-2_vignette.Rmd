...
## 1.1. State Space Specification - A Simple Baseline
...
## 1.4. Tune Hyperparameters: Adjust Bayesian Priors
...
st.sp3 <- AddLocalLevel(st.sp3, y.pre.treat.NAs.post, 
  initial.state.prior = NormalPrior(mu=0, sigma = .1, fixed = FALSE)
)
## Add seasonality to state space (52 weekly periods = 1 yearly cycle) 
