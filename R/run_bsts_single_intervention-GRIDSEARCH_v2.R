...
# ## 
# treat.rules <- c('random','below.benchmark')
# prior.sd.scenarios <- c('sd.high','sd.low')
...
#   c('AddLocalLevel'),
#   ## ## TREND
#   c('AddLocalLinearTrend'),
#   c('AddStudentLocalLinearTrend'),
#   ## ## LEVEL + SLOPE ( + AR SLOPE DRIFT)
#   c('AddSemilocalLinearTrend'),
#   ## ## SEASONAL
#   c('AddTrig'),
#   ## ## AUTOCORRELATION
#   # list('AddAr'),
...
#   c('AddTrig','AddAutoAr'),
#   ## LEVEL + ...
#   c('AddLocalLevel','AddTrig'),
#   c('AddLocalLevel','AddAutoAr'),
#   c('AddLocalLevel','AddTrig','AddAutoAr'),
#   ## (LEVEL + SLOPE) + ...
#   c('AddLocalLinearTrend','AddTrig'),
#   c('AddLocalLinearTrend','AddAutoAr'),
#   c('AddLocalLinearTrend','AddTrig','AddAutoAr'),
#   c('AddStudentLocalLinearTrend','AddTrig'),
#   c('AddStudentLocalLinearTrend','AddAutoAr'),
#   c('AddStudentLocalLinearTrend','AddTrig','AddAutoAr'),
#   ## (LEVEL + SLOPE ( + AR1 SLOPE DRIFT)) + ...
#   c('AddTrig','AddSemilocalLinearTrend')#,
# )
# ## FOCAL CONSTRUCT
# dgp.ars <- list(0,.04,.08,.16,.32)  ## 0.6
# ##
# simlist <- list()
# for (h in 1:length(dgp.ars)) {
#   dgp.ar <- dgp.ars[[ h ]]
#   
...
#           bsts.state.config <- getStateSpaceConfBySimScenario(st.sp.vec[ kk ], prior.sd.scenario)#, ## c('sd.high','sd.low')
...
#     ## Append simulation configuration to simlist
#     ##--------------------------------------------
#     simlist[[ sprintf('ar%s',dgp.ar) ]] <- list(
#       n = n,    ## Number of firms
